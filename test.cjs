...
const inputs = [
  "\"A vida eterna\" → (Resultado / Dom Concedido) - Complemento subentendido da ação de DEUS no versículo 6.",
  "[ • Porque ] → (Causa/Razão: Liga o dom divino à ausência de terror do versículo 28)",
  "[ Fazei todas as coisas ] → [ Mandato Imperativo / Núcleo do Comando ]",
  "[ [ Modo Negativo / Atitude para com DEUS ] : \"sem murmurações\" ] → (Indica a ausência de insatisfação providencial)",
  "[ Modo Negativo / Atitude para com o Próximo ] → Adição ] : \"nem contendas\" (Indica a ausência de disputas intelectuais ou relacionais)"
];
